...
//		queryOportunities = "http://shannon.gsi.dit.upm.es/episteme/lmf/sparql/select?query="+queryOportunities+"&output=json";
	 ...
	 * @throws JSONException
	 */
	public void getOportunities2() throws JSONException {

		String queryOportunities = "http://minsky.gsi.dit.upm.es/episteme/tomcat/LMF/config/data/episteme.search.search999";
		JSONObject oportunities = getJson(queryOportunities);
		System.out.println(oportunities.getJSONObject("\"episteme.search.search999\""));
